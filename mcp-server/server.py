...
async def handle_optimize(request: Request):
    """
    POST /optimize
    Body: { "patients": [...], "gamma": 1.5, "or_capacity_minutes": 480, "start_time": "07:30" }
    Response: { "schedule": [...], "rejected": [...], "summary": {...} }
    """
    try:
...
# CORS — pozwala React Dashboard (Netlify/localhost) wywołać /optimize
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],      # na produkcji zawęź do domeny Netlify
    allow_methods=["*"],
    allow_headers=["*"],
)
